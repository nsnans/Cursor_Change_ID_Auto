...
> 本工具完全免费，不进行任何收费
>
> 获取最新版本请加入QQ群：631250950（群满加二群）

> 不直接发布在Github原因已经很明了，防止被倒卖。国内的开源环境就这样，差得很

## 🚀 最新更新 v7.4.0
- 新增支持 Cursor v0.47.x 版（win理论全部通杀）
- 优化界面显示和用户体验
...
---
**文档最后更新时间：2025-03-18 12:00**

**脚本更新在群里通知，上面只是文档**

_如果觉得好用，请推荐给身边的朋友，一起加入QQ群：631250950_ （群满加二群）